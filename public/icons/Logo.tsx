    ...
    <svg viewBox="0 0 64 64" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="logo-grad" x1="0" y1="0" x2="64" y2="64" gradientUnits="userSpaceOnUse">
          ...
          <stop offset="1" stopColor="#a67a0a" />
        </linearGradient>
      </defs>
      ...
      <line x1="40" y1="34" x2="45" y2="29" stroke="#b8860b" strokeWidth="1.4" />
      <line x1="40" y1="34" x2="44" y2="38" stroke="#a67a0a" strokeWidth="1.4" />
      <circle cx="40" cy="34" r="2.4" fill="#b8860b" />
      <circle cx="45" cy="29" r="2.4" fill="#b8860b" />
      <circle cx="44" cy="38" r="2.4" fill="#a67a0a" />
    </svg>
  );
  ...
  return (
    <div className={`flex items-center gap-2.5 ${className}`}>
      ...
      <span className="font-black text-lg tracking-tight text-foreground">
        Edu<span className="text-primary">MRM</span>
      </span>
    </div>
  );
}
