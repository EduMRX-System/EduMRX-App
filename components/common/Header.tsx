        ...
        <div className="mx-auto px-6 h-16 flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-1 shrink-0">
                ...
                <button
                    ...
                    className="relative w-9 h-9 flex items-center justify-center rounded-lg text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-all duration-300 cursor-pointer overflow-hidden"
