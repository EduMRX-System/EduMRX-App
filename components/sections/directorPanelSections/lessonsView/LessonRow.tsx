        ...
        <tr className="transition hover:bg-hover/50">
            ...
            <td className="px-5 py-3.5">
                <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                        ...
                        {lesson.notes && (
                            <p className="mt-0.5 line-clamp-1 max-w-[280px] text-[11px] text-foreground-subtle">{lesson.notes}</p>
                        )}
                    </div>
                </div>
            </td>
            ...
            <td className="px-5 py-3.5">
                <span className="inline-flex items-center gap-1.5 text-foreground-muted">
                    <Users2 className="h-3.5 w-3.5 text-foreground-subtle" />
                    {lesson.group_name || "—"}
                </span>
            </td>

            {/* Sana */}
            <td className="px-5 py-3.5 text-foreground-muted">{lesson.date || "—"}</td>
