        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className={`bg-surface p-6 rounded-xl max-w-md w-full relative z-10 shadow-2xl border border-border-subtle transform transition-all duration-300 ${isMounted ? "opacity-100 scale-100" : "opacity-0 scale-95"}`}>
                ...
                <div className="mt-6 flex items-center justify-end gap-3">
                    ...
                    <button type="button" onClick={() => deleteLesson()} disabled={isPending} className="inline-flex items-center justify-center gap-2 h-10 px-5 bg-danger hover:bg-danger/90 text-white text-sm font-semibold rounded-lg disabled:opacity-60 cursor-pointer transition-colors">
