...
export default function SearchSelect({
    ...
    return (
        <div ref={ref} className="relative">
            ...
            <div
                onClick={() => setOpen((v) => !v)}
                className={`border rounded-lg w-full h-[40px] px-3 text-[14px] flex items-center justify-between cursor-pointer bg-surface transition-colors ${error ? "border-red-300 dark:border-red-800" : "border-border"
