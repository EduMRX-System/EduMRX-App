    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 className="text-xl font-semibold text-slate-900 dark:text-slate-100">{t("director.courses.title")}</h1>
                    <p className="mt-0.5 text-sm text-slate-500 dark:text-slate-400">{t("director.courses.count", { count })}</p>
                </div>
                <button
                            ...
                            {isLoading ? (
                                ...
                                <tr>
                                    <td colSpan={5} className="px-5 py-16 text-center">
                                        ...
                                        <p className="text-sm font-medium text-slate-600 dark:text-slate-300">{t("director.courses.empty.title")}</p>
                                        <p className="mt-1 text-sm text-slate-400">{t("director.courses.empty.desc")}</p>
                                    </td>
                                </tr>
                            ) : (
                                courses.map((c) => (
