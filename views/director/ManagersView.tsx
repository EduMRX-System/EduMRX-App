    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 className="text-xl font-semibold text-slate-900 dark:text-slate-100">{t("director.managers.title")}</h1>
                    <p className="mt-0.5 text-sm text-slate-500 dark:text-slate-400">{t("director.managers.count", { count })}</p>
                </div>
                            ...
                            {isLoading ? (
                                ...
                                <tr>
                                    <td colSpan={5} className="py-16 text-center">
                                        ...
                                        <p className="text-sm font-medium text-slate-600 dark:text-slate-300">{t("director.managers.empty.title")}</p>
                                        <p className="mt-1 text-sm text-slate-400">{t("director.managers.empty.desc")}</p>
                                    </td>
                                </tr>
                            ) : (
                                managers.map((m) => (
